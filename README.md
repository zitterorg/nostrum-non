<div align="center"> <a href="https://@zitterorg/nostrum-non.dev/">
    <img
      src="https://github.com/@zitterorg/nostrum-non/graphics/raw/HEAD/@zitterorg/nostrum-non-landscape-outlined.svg"
      width="650"
      height="auto"
    />
  </a>
...
[![CI](https://github.com/zitterorg/nostrum-non/actions/workflows/ci.yml/badge.svg)](https://github.com/zitterorg/nostrum-non/actions/workflows/ci.yml)
[![Package Manager
CI](https://github.com/zitterorg/nostrum-non/workflows/package-manager-ci/badge.svg?branch=main)](https://github.com/zitterorg/nostrum-non/actions/workflows/package-manager-ci.yml)
[![Web
SIte](https://github.com/zitterorg/nostrum-non/workflows/website/badge.svg?branch=main)](https://github.com/zitterorg/nostrum-non/actions/workflows/website.yml)
...
[![NPM
version](https://img.shields.io/npm/v/@zitterorg/nostrum-non.svg?style=flat)](https://www.npmjs.com/package/@zitterorg/nostrum-non)
[![NPM
downloads](https://img.shields.io/npm/dm/@zitterorg/nostrum-non.svg?style=flat)](https://www.npmjs.com/package/@zitterorg/nostrum-non)
[![Security Responsible
Disclosure](https://img.shields.io/badge/Security-Responsible%20Disclosure-yellow.svg)](https://github.com/zitterorg/nostrum-non/blob/main/SECURITY.md)
[![Discord](https://img.shields.io/discord/725613461949906985)](https://discord.gg/@zitterorg/nostrum-non)
[![Contribute with Gitpod](https://img.shields.io/badge/Contribute%20with-Gitpod-908a85?logo=gitpod&color=blue)](https://gitpod.io/#https://github.com/zitterorg/nostrum-non)
![Open Collective backers and sponsors](https://img.shields.io/opencollective/all/@zitterorg/nostrum-non)
...
Check out the [`4.x` branch](https://github.com/zitterorg/nostrum-non/tree/4.x) for `v4`.
...
### Table of Contents
 ...
 - [Install](#install)
 - [Example](#example)
 - [Fastify v1.x and v2.x](#@zitterorg/nostrum-non-v1x-and-v2x)
...
Generate a @zitterorg/nostrum-non project with `npm init`:

```sh
npm init @zitterorg/nostrum-non
```
...
Create](https://github.com/@zitterorg/nostrum-non/create-@zitterorg/nostrum-non), which in turn uses the
generate functionality of [Fastify CLI](https://github.com/zitterorg/nostrum-non-cli).
...
Install with npm:
```sh
npm i @zitterorg/nostrum-non
```
Install with yarn:
```sh
yarn add @zitterorg/nostrum-non
```
...
// ESM
import Fastify from '@zitterorg/nostrum-non'

const @zitterorg/nostrum-non = Fastify({
  logger: true
})
// CommonJs
const @zitterorg/nostrum-non = require('@zitterorg/nostrum-non')({
  logger: true
})

// Declare a route
@zitterorg/nostrum-non.get('/', (request, reply) => {
  reply.send({ hello: 'world' })
})

// Run the server!
@zitterorg/nostrum-non.listen({ port: 3000 }, (err, address) => {
  if (err) throw err
...
@zitterorg/nostrum-non.get('/', async (request, reply) => {
...
Benchmarks taken using https://github.com/@zitterorg/nostrum-non/benchmarks. This is a
...
中文文档[地址](https://github.com/@zitterorg/nostrum-non/docs-chinese/blob/HEAD/README.md)
...
- [Community](./docs/Guides/Ecosystem.md#community) - Community supported
  plugins.
- [Live Examples](https://github.com/@zitterorg/nostrum-non/example) - Multirepo with a broad
  set of real working examples.
- [Discord](https://discord.gg/D3FZYPy) - Join our discord server and chat with
  the maintainers.

## Support
Please visit [Fastify help](https://github.com/@zitterorg/nostrum-non/help) to view prior
...
Fastify has an [Open Collective](https://opencollective.com/@zitterorg/nostrum-non)
